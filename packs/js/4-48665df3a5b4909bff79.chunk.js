...
var fault = __webpack_require__(/*! fault */ "./node_modules/fault/index.js"); // The lowlight interface, which has to be compatible with highlight.js, as
...
/***/ "./node_modules/prosemirror-collab/dist/collab.js":
/*!********************************************************!*\
  !*** ./node_modules/prosemirror-collab/dist/collab.js ***!
  \********************************************************/
/*! no static exports found */
...
var collabKey = new prosemirrorState.PluginKey("collab"); // :: (?Object) → Plugin
//
...
var prosemirrorState = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.js"); // :: (EditorState, ?(tr: Transaction)) → bool
...
var prosemirrorModel = __webpack_require__(/*! prosemirror-model */ "./node_modules/prosemirror-model/dist/index.js"); // ::- Gap cursor selections are represented using this class. Its
...
function handleClick(view, pos, event) {
  if (view.someProp("editable", function (editable) {
    return editable(view.state) === false;
  })) {
    return false;
  }
...
var prosemirrorState = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.js"); // ProseMirror's history isn't simply a way to roll back to a previous
...
var closeHistoryKey = new prosemirrorState.PluginKey("closeHistory"); // :: (?Object) → Plugin
...
var prosemirrorTransform = __webpack_require__(/*! prosemirror-transform */ "./node_modules/prosemirror-transform/dist/index.js"); // ::- Input rules are regular expressions describing a piece of text
...
var prosemirrorState = __webpack_require__(/*! prosemirror-state */ "./node_modules/prosemirror-state/dist/index.js"); // declare global: navigator
...
var prosemirrorKeymap = __webpack_require__(/*! prosemirror-keymap */ "./node_modules/prosemirror-keymap/dist/keymap.js"); // Because working with row and column-spanning cells is not quite
...
TableMap.prototype.findCell = function findCell(pos) {
  ...
  for (var i = 0; i < this.map.length; i++) {
    ...
    var left = i % this$1.width,
        top = i / this$1.width | 0;
    var right = left + 1,
        bottom = top + 1;
...
TableMap.prototype.cellsInRect = function cellsInRect(rect) {
  ...
  for (var row = rect.top; row < rect.bottom; row++) {
    for (var col = rect.left; col < rect.right; col++) {
      var index = row * this$1.width + col,
          pos = this$1.map[index];
      ...
      if ((col != rect.left || !col || this$1.map[index - 1] != pos) && (row != rect.top || !row || this$1.map[index - this$1.width] != pos)) {
        result.push(pos);
      }
    }
  }
...
TableMap.prototype.positionAt = function positionAt(row, col, table) {
  ...
  for (var i = 0, rowStart = 0;; i++) {
    ...
    if (i == row) {
      var index = col + row * this$1.width,
          rowEndIndex = (row + 1) * this$1.width; // Skip past cells from previous rows (via rowspan)
      ...
      for (var index = row * map.width + rect.left, col = rect.left; col < rect.right; col++, index++) {
        ...
        if (!seen[pos]) {
          ...
          if (extraLeft > 0 || extraRight > 0) {
            ...
            if (extraLeft > 0) {
              attrs = rmColSpan(attrs, 0, extraLeft);
            }

            if (extraRight > 0) {
              attrs = rmColSpan(attrs, attrs.colspan - extraRight, extraRight);
            }
...
function pastedCells(slice) {
  ...
  if (role == "row") {
    for (var i = 0; i < content.childCount; i++) {
      ...
      if (left || right) {
        cells = fitSlice(tableNodeTypes(schema).row, new prosemirrorModel.Slice(cells, left, right)).content;
      }
...
function growTable(tr, map, table, start, width, height, mapFrom) {
  ...
  if (height > map.height) {
    ...
    var emptyRow = types.row.create(null, prosemirrorModel.Fragment.from(cells$1)),
        rows = [];
  ...
  if (dispatch) {
    ...
    sel.forEachCell(function (cell, pos) {
      if (!cell.content.eq(baseContent)) {
        tr.replace(tr.mapping.map(pos + 1), tr.mapping.map(pos + cell.nodeSize - 1), new prosemirrorModel.Slice(baseContent, 0, 0));
      }
    });
...
var prosemirrorTables = __webpack_require__(/*! prosemirror-tables */ "./node_modules/prosemirror-tables/dist/index.js"); // :: (nodeType: union<NodeType, [NodeType]>) → (tr: Transaction) → Transaction
...
var DOMObserver = function DOMObserver(view, handleDOMChange) {
  ...
  this.observer = window.MutationObserver && new window.MutationObserver(function (mutations) {
    ...
    if (result.ie && result.ie_version <= 11 && mutations.some(function (m) {
      return m.type == "childList" && m.removedNodes.length == 1 && m.removedNodes[0].parentNode == m.target;
    })) {
      setTimeout(function () {
...
MouseDown.prototype.up = function up(event) {
  ...
  // works around that.
  result.chrome && !(this.view.state.selection instanceof prosemirrorState.TextSelection) && (pos.pos == this.view.state.selection.from || pos.pos == this.view.state.selection.to)) {
...
/* harmony import */ var prosemirror_transform__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(prosemirror_transform__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var prosemirror_collab__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! prosemirror-collab */ "./node_modules/prosemirror-collab/dist/collab.js");
/* harmony import */ var prosemirror_collab__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(prosemirror_collab__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var prosemirror_history__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! prosemirror-history */ "./node_modules/prosemirror-history/dist/history.js");
...
//# sourceMappingURL=4-48665df3a5b4909bff79.chunk.js.map